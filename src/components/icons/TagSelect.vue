<template>
    <div class="flex items-center justify-between p-2 rounded-lg cursor-pointer transition duration-300 hover:bg-gray-100"
        @click="toggleSelect">
        <div class="flex items-center">
            <img :src="tag.image_url" :alt="tag.name" class="w-4 h-4 mr-3" />
            <span>{{ tag.name }}</span>
        </div>
